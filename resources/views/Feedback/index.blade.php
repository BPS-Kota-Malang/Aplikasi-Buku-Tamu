        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <div class="fadeIn first">
                    <img src="{{ asset('pengguna/assets/images/1726px-lambang-badan-pusat-statistik-bps-indonesia.svg-123x95.png') }}" id="icon" alt="User Icon">
                </div>
                <br>
                <h3>Feedback</h3>
...
>>>>>>> 968ea07b9f5f34b3634bdd416efffd6a262a2d3d
                        ...
                        <div class="mb-3">
                            ...
                            <input class="btn btn-primary fadeIn fourth" type="submit" value="Submit" style="margin-top: 20px; padding: 15px 80px;">
                        </div>
                    </form>
                </div>
            </div>
